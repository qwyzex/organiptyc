...
//                     orgData[subcollectionName] = subcollectionSnap.docs.map((doc) => ({
//                         id: doc.id,
//                         ...doc.data(),
//                     }));
//                 }
...
//                 for (const subcollectionName of subcollections) {
//                     const subcollectionRef = collection(db, `organizations/${orgId}/${subcollectionName}`);
//                     const subcollectionSnap = await getDocs(subcollectionRef);
//                     orgData[subcollectionName] = await Promise.all(
//                         subcollectionSnap.docs.map(async (docu) => {
