...
const ProgramFiles = () => {
    ...
    useEffect(() => {
        const fetchFilesAndFolders = async () => {
            const listRef = ref(
                storage,
                `organization/${orgId}/programs/${programId}/${path}`
            );
    ...
    }, [orgId, authUser, programId, path, rerenderer]);
 ...
 * @param {string} props.programId The program ID.
    ...
    const handleFileUpload = async (files: any) => {
        ...
        for (const file of files) {
            ...
            const storageRef = ref(
                storage,
                `organization/${orgId}/programs/${programId}/${path}/${file.name}`
            );
